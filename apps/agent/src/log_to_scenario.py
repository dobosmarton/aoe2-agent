...
CLI:
    python -m gameplay_agent.log_to_scenario logs/2026_04_25/game.txt --list
    python -m gameplay_agent.log_to_scenario logs/2026_04_25/game.txt --turn 8 \
        --out gameplay_agent/scenarios/regression/turn_8_food_emergency.yaml
    python -m gameplay_agent.log_to_scenario logs/2026_04_25/game.txt --auto \
        --out-dir gameplay_agent/scenarios/regression/
