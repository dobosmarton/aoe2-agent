...
The four tabs in `arena/web/ui/src/App.tsx` are the operator's main surface:
...
`src/panels/operator.tsx`. The form fields map directly to `ForkRequest` (`arena/web/forks.py:77`):
