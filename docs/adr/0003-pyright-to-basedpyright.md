...
- Catches subtle bugs at type-check time (numpy stubs returning `Any` from `.shape[i]` is the canonical one — see `arena/ranking.py:104`'s carefully-typed BT solver).
