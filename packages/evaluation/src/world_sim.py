...
# ---------------------------------------------------------------------------
# WorldState + AGE_SEQUENCE live in `core.world_state` (re-exported above
# from `core`) so producers / consumers don't need to depend on this module
# just to traffic the type.
# ---------------------------------------------------------------------------
